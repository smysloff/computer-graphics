# Лекция №3: "Окружность по Брезенхему (алгоритм средней точки)"

Основная идея: Мы используем симметрию окружности. Нам не нужно считать всю окружность, достаточно рассчитать точки для одной октанты (1/8 части), а остальные достроить просто меняя знаки и координаты!
